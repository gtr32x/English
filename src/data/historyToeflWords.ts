...
export const historyToeflWords: Word[] = [
  ...
  },
  {
    ...
    pronunciation: '/ɪnˈdʌstriəl ˌrevəˈluːʃən/',
    partOfSpeech: 'noun',
  ...
  },
  {
    ...
    pronunciation: '/toʊˌtæləˈteriəˌnɪzəm/',
    partOfSpeech: 'noun',
...
// 按历史时期筛选词汇
export const getAncientHistoryWords = () => 
  historyToeflWords.filter(word => 
    ['civilization', 'empire', 'democracy'].includes(word.word)
  );

export const getMedievalHistoryWords = () => 
  historyToeflWords.filter(word => 
    ['feudalism', 'monarchy'].includes(word.word)
  );

export const getModernHistoryWords = () => 
  historyToeflWords.filter(word => 
    ['renaissance', 'enlightenment', 'reformation', 'industrial revolution'].includes(word.word)
  );

export const getContemporaryHistoryWords = () => 
  historyToeflWords.filter(word => 
    ['cold war', 'totalitarianism', 'genocide'].includes(word.word)
  );

// 按政治制度筛选词汇
export const getPoliticalSystemsWords = () => 
  historyToeflWords.filter(word => 
    ['democracy', 'monarchy', 'totalitarianism', 'socialism', 'capitalism'].includes(word.word)
  );

export const getGovernmentStructureWords = () => 
  historyToeflWords.filter(word => 
    ['constitution', 'amendment', 'sovereignty'].includes(word.word)
  );

// 按社会运动筛选词汇
export const getSocialMovementsWords = () => 
  historyToeflWords.filter(word => 
    ['civil rights', 'suffrage', 'revolution', 'nationalism'].includes(word.word)
  );

// 按国际关系筛选词汇
export const getInternationalRelationsWords = () => 
  historyToeflWords.filter(word => 
    ['diplomacy', 'treaty', 'alliance', 'colonialism', 'imperialism'].includes(word.word)
  );

// 按经济制度筛选词汇
export const getEconomicSystemsWords = () => 
  historyToeflWords.filter(word => 
    ['capitalism', 'socialism', 'feudalism', 'industrial revolution'].includes(word.word)
  );

// 按文化运动筛选词汇
export const getCulturalMovementsWords = () => 
  historyToeflWords.filter(word => 
    ['renaissance', 'enlightenment', 'reformation'].includes(word.word)
  );
...
export const getSocialConceptsWords = () => 
  historyToeflWords.filter(word => 
    ['ideology', 'propaganda', 'migration', 'assimilation'].includes(word.word)
  );

// 按政治理论筛选词汇
export const getPoliticalTheoryWords = () => 
  historyToeflWords.filter(word => 
    ['democracy', 'totalitarianism', 'nationalism', 'sovereignty', 'ideology'].includes(word.word)
  );

// 按冲突与和平筛选词汇
export const getConflictAndPeaceWords = () => 
  historyToeflWords.filter(word => 
    ['revolution', 'cold war', 'genocide', 'diplomacy', 'treaty', 'alliance'].includes(word.word)
  );