...
export const technologyToeflWords: Word[] = [
  ...
  },
  {
    id: 17014,
    word: 'nanotechnology',
    pronunciation: '/ˌnænoʊtekˈnɑːlədʒi/',
    partOfSpeech: 'noun',
  ...
  },
  {
    id: 17015,
    word: 'biotechnology',
    pronunciation: '/ˌbaɪoʊtekˈnɑːlədʒi/',
    partOfSpeech: 'noun',
  ...
  },
  {
    id: 17029,
    word: 'microprocessor',
    pronunciation: '/ˌmaɪkroʊˈprɑːsesər/',
    partOfSpeech: 'noun',
  ...
  },
  {
    ...
    pronunciation: '/ˌteləkəˌmjuːnɪˈkeɪʃənz/',
    partOfSpeech: 'noun',
...
// 按技术领域筛选词汇
export const getComputerScienceWords = () => 
  technologyToeflWords.filter(word => 
    ['algorithm', 'programming', 'software', 'hardware', 'database'].includes(word.word)
  );

export const getArtificialIntelligenceWords = () => 
  technologyToeflWords.filter(word => 
    ['artificial intelligence', 'machine learning', 'algorithm', 'automation'].includes(word.word)
  );

export const getCybersecurityWords = () => 
  technologyToeflWords.filter(word => 
    ['cybersecurity', 'encryption', 'network', 'security'].includes(word.word)
  );

export const getEmergingTechWords = () => 
  technologyToeflWords.filter(word => 
    ['blockchain', 'virtual reality', 'nanotechnology', 'biotechnology'].includes(word.word)
  );
...
export const getEngineeringWords = () => 
  technologyToeflWords.filter(word => 
    ['prototype', 'simulation', 'optimization', 'integration'].includes(word.word)
  );

export const getDataScienceWords = () => 
  technologyToeflWords.filter(word => 
    ['database', 'algorithm', 'machine learning', 'analytics'].includes(word.word)
  );